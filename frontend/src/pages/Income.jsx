...
const Income = () => {
  ...
  // to get the token from localStrorage
  ...
  const incomeTransactions = useMemo(
    ...
    [outletTransactions],
  ); // filter transaction coming from oultetcontext
  ...
  // to delte an income transaction
