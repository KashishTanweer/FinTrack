...
const ExpensePage = () => {
  ...
  const handleAddTransaction = async () => {
    ...
    try {
      ...
      //This payload object is preparing the data that will be sent to the backend API when creating a new expense.
      const payload = {
...
// similar to income page
// similar fun we just replace the income with expense