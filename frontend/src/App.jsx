...
// to protect the routes until user logged in
...
// to scroll to top when page gets reload or now page is visited
const ScrollToTop = () => {
...
const App = () => {
  ...
  // to update the user data in state and storage
  ...
  // try to load user details with token when mounted
  useEffect(() => {
  (async () => {
    try {
  ...
  return (
    ...
    <Routes>
      ...
      <Route
        ...
        {/* If user exists (logged in) → Go to / (Dashboard).
        If user doesn't exist (not logged in) → Go to /login. */}
    </Routes>
    </>
