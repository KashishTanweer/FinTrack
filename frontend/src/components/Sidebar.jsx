...
const Sidebar = ({user, isCollapsed, setIsCollapsed}) => {
  ...
  // clicl outside sidebar get collapsed
  useEffect(() => {
  ...
  return (
        ...
        animate={{
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className='flex-1 overflow-y-auto py-4 custom-scroller'>
                ...
                <div className={cn(
                    ...
                    <HelpCircle sixe={20} className='text-gray-500'/>
    ...
    <motion.button onClick={() => setMobileOpen((prev) => !prev)}
        ...
        whileHover={{scale: 1.05}} whileTap={{scale:0.95}}>
            {mobileOpen ? <X sixe={24}/> : <Menu size={24}/>}
            ...
            >
                <div className='relative h-full flex flex-col'>
                    ...
                    <div className={sidebarStyles.mobileFooter}>
                        ...
                        to="https://hexagondigitalservices.com/contact" className={sidebarStyles.mobileFooterLink}>
