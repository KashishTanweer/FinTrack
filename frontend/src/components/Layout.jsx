import React, {Activity, useMemo, useState, useEffect} from 'react'
            ...
            <div className={styles.statCards.grid}>
                <div className={styles.statCards.card}>
                    <div className={styles.statCards.cardHeader}>
                        ...
                        <div className={styles.statCards.iconContainer("teel")}>
                            <DollarSign className={styles.statCards.icon("teel")} />
                        </div>
                    </div>
                    <p className={styles.statCards.cardFooter}>
                        <span className='text-teel-600 font-medium'>
                    ...
                    <div className={styles.cards.base}>
                        <div className={styles.cards.header}>
                            <h3 className={styles.cards.title}>
                                <TrendingUp className="w-6 h-6 teaxt-teal-500" />
                                Financial Overview

                                <span className='text-sm text-gray-500 fpnt-normal'>
                                    ({timeFrameLabel})
                                </span>
                            </h3>
                        </div>
